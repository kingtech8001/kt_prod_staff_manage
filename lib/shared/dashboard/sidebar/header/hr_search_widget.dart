...
import '../../../../features/admin/widgets/admin_employee_search_overlay.dart';
import '../../../employee_management_controller.dart';

class HrSearchWidget extends StatelessWidget {
  HrSearchWidget({super.key});
  ...
  Widget build(BuildContext context) {
    final directory = Get.find<HrDirectoryController>();
                    ...
                    return Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final user = directory.searchResults[index];
